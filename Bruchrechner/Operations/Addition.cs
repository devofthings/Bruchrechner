 ...
 * Klasse: IA119
 * Datum: 27.07.2020
 * Beschreibung: Diese Funktion erlaubt das addieren von 2 Brüchen.
*/
...
namespace Bruchrechner
{
    ...
    {
        public static void Addition(ref int newZaehler, ref int newNenner, int zaehlerOne, int nennerOne, int zaehlerTwo, int nennerTwo)
        {
